<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin_CSSHTML/Masteradmin.Master" CodeBehind="editMateri.aspx.vb" Inherits="csshtml.editMateri" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Content_isi" runat="server">
     <div class="wthree_general graph-form agile_info_shadow ">
        <h3 class="w3_inner_tittle two">Edit Materi</h3>
        <div class="grid-1 ">
            <div class="form-body">
                <form class="form-horizontal" runat="server">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <asp:Button ID="btn_editMateri" runat="server" Text="Simpan Pembaharuan" />
                        </div>
                        <div class="col-sm-2">
                            <p class="help-block">
                                <!-- for Required -->
