                ...
                <div class="col-md-3 banner-bottom-grid-left">
                    <div class="br-bm-gd-lt br-bm-gd-lt2">
                        ...
                        <div class="health-pos">
                            <div class="health">
                                <ul>
                                    <li><a href="../MEMBER_CSSHTML/htmlMember1.aspx" class="plane">Basic</a></li>
                                    <li>Pertemuan 1</li>
                                </ul>
                            </div>
                ...
                <div class="col-md-3 banner-bottom-grid-left">
                    <div class="br-bm-gd-lt br-bm-gd-lt2">
                        ...
                        <div class="health-pos">
                            <div class="health">
                                <ul>
                                    <li><a href="../MEMBER_CSSHTML/htmlMember1.aspx" class="plane">Basic 2</a></li>
                                    <li>Pertemuan 1</li>
                                </ul>
                            </div>
                            <h3>But I must explain to you how all this mistaken idea.</h3>
                ...
                <div class="col-md-3 banner-bottom-grid-left">
                    <div class="br-bm-gd-lt br-bm-gd-lt2">
                        ...
                        <div class="health-pos">
                            <div class="health">
                                <ul>
                                    <li><a href="../MEMBER_CSSHTML/htmlMember1.aspx" class="plane">Basic 3</a></li>
                                    <li>Pertemuan 2</li>
                                </ul>
                            </div>
                            <h3>But I must explain to you how all this mistaken idea.</h3>
                ...
                <div class="col-md-3 banner-bottom-grid-left">
                    <div class="br-bm-gd-lt br-bm-gd-lt3">
                        ...
                        <div class="health-pos">
                            <div class="health">
                                <ul>
                                    <li><a href="../MEMBER_CSSHTML/htmlMember1.aspx" class="general">Media</a></li>
                                    <li>Pertemuan 2</li>
                                </ul>
                            </div>
                            <h3>But I must explain to you how all this mistaken idea.</h3>
                ...
                <div class="col-md-3 banner-bottom-grid-left">
                    <div class="br-bm-gd-lt br-bm-gd-lt4">
                        ...
                        <div class="health-pos">
                            <div class="health">
                                <ul>
                                    <li><a href="../MEMBER_CSSHTML/htmlMember1.aspx" class="pol">Form</a></li>
                                    <li>Pertemuan 3</li>
                                </ul>
                            </div>
                            <h3>But I must explain to you how all this mistaken idea.</h3>
                ...
                <div class="col-md-3 banner-bottom-grid-left">
                    <div class="br-bm-gd-lt br-bm-gd-lt5">
                        ...
                        <div class="health-pos">
                            <div class="health">
                                <ul>
                                    <li><a href="../MEMBER_CSSHTML/htmlMember1.aspx" class="world">Table</a></li>
                                    <li>Pertemuan 3</li>
                                </ul>
                            </div>
                            <h3>But I must explain to you how all this mistaken idea.</h3>
                ...
                <div class="col-md-3 banner-bottom-grid-left">
                    <div class="br-bm-gd-lt br-bm-gd-lt6">
                        ...
                        <div class="health-pos">
                            <div class="health">
                                <ul>
                                    <li><a href="../MEMBER_CSSHTML/htmlMember1.aspx" class="national">Website 1</a></li>
                                    <li>Pertemuan 4</li>
                                </ul>
                            </div>
                            <h3>But I must explain to you how all this mistaken idea.</h3>
                ...
                <div class="col-md-3 banner-bottom-grid-left">
                    <div class="br-bm-gd-lt br-bm-gd-lt7">
                        ...
                        <div class="health-pos">
                            <div class="health">
                                <ul>
                                    <li><a href="../MEMBER_CSSHTML/htmlMember1.aspx" class="business">Website 2</a></li>
                                    <li>Pertemuan 4</li>
                                </ul>
                            </div>
                            <h3>But I must explain to you how all this mistaken idea.</h3>
